...
class CoordAtt(nn.Module):
    ...
    def __init__(self, channels: int, reduction: int = 32):
        ...
        Args:
            ...
            reduction (int): Channel reduction ratio for the intermediate conv.
        """
        super().__init__()
...
class C3k2(C2f):
    ...
    def __init__(
        ...
        Args:
            ...
            c3k (bool): Whether to use C3k blocks instead of plain Bottleneck.
            e (float): Expansion ratio.
            attn (bool): Whether to use PSABlock-augmented Bottleneck blocks.
            ca (bool): Whether to append a Coordinate Attention module on the output.
            g (int): Groups for convolutions.
            shortcut (bool): Whether to use shortcut connections.
        """
        super().__init__(c1, c2, n, shortcut, g, e)

        # Original block list — unchanged
        ...
        # Coordinate Attention on the final c2-channel output
        self.ca_attn = CoordAtt(c2) if ca else None
